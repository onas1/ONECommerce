...
{
    public class OneCommerceContextSeed
    {
        public static async Task SeedAsync(OneCommerceContext Context, ILoggerFactory loggerFactory, int? retry = 0)
        {
            ...
            catch (Exception exception)
            {
                if (retryForAvailability < 10)
                {
                    ...
                    var log = loggerFactory.CreateLogger<OneCommerceContextSeed>();
